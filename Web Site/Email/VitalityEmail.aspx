<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VitalityEmail.aspx.vb" Inherits="Email_VitalityEmail" %>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <table width="230" cellpadding="0" cellspacing="0" border="0" align="center" class="fullwidth">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td width="157" style="font-family: arial, helvetica; font-size: 8px; text-align: right; color: #929295; width: 132px;" class="hidethis">
                                                                            </td>
                                                                            <td width="8"></td>
                    ...
                    <tr>
                        ...
                        <td width="380">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="left" class="width-260px ml15">
                                <tr>
                                    <td height="42" align="left" valign="middle" style="color: #fff; font-family: arial, helvetica; font-size: 18px; text-align: left; line-height: 21px;" class="fsz15">Appointment confirmation
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <tr>
                    ...
                    <tr>
                        <td align="center" class="fullwidth" valign="top">
                            <table width="400" cellpadding="0" cellspacing="0" border="0" align="left" class="max-width">
                                ...
                                <tr>
                                    <td align="left" style="font-family: arial, helvetica; font-size: 16px; text-align: left">Dear <%= _App.TheCompany.ContactFirstNameOrSurnameAndTitle %></td>
                                </tr>
                                <tr>
                                    <td style="height: 20px"></td>
                                </tr>
                                <tr>
                                    <td align="left" style="font-family: arial, helvetica; text-align: left; font-size: 16px; font-weight: bold; line-height: 18px;">Thank you for confirming our meeting.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 20px"></td>
                                ...
                                <tr>
                                    <td align="left">
                                        <table width="340" cellpadding="0" cellspacing="0" border="0" align="left" class="max-width">
                                                    ...
                                                    <table width="300" cellpadding="0" cellspacing="0" border="0" align="center" class="width-260px">
                                                        ...
                                                        <tr>
                                                            <td height="33" align="left" valign="middle" style="color: #fff; text-align: left; font-family: arial, helvetica; font-size: 14px; background-color: #f8116a">
                                                                <strong>Your appointment details:</strong>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center" style="background-color: #ebebeb" height="30">
                                                    <table width="300" cellpadding="0" cellspacing="0" border="0" align="center" class="width-260px">
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="middle" style="color: #001; font-family: arial, helvetica; font-size: 14px; width: 35px;">With:
                                                            </td>
                                                            <td style="width: 50px"></td>
                                                            <td align="left" valign="middle" style="color: #001; font-family: arial, helvetica; font-size: 14px; width: 215px;"><%=_App.Rep.RealName %>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center" style="background-color: #ffffff" height="31">
                                                    <table width="300" cellpadding="0" cellspacing="0" border="0" align="center" class="width-260px">

                                                        <tr>
                                                            <td align="left" valign="middle" style="color: #001; font-family: arial, helvetica; font-size: 14px; width: 35px;">Date:
                                                            </td>
                                                            <td style="width: 50px"></td>
                                                            <td align="left" valign="middle" style="color: #001; font-family: arial, helvetica; font-size: 14px; width: 215px;">
                                                                <span class="datetime"><%= _App.AppointmentDate %></span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center" style="background-color: #ebebeb" height="33">
                                                    <table width="300" cellpadding="0" cellspacing="0" border="0" align="center" class="width-260px">
                                                        <tr>
                                                            <td align="left" valign="middle" style="color: #001; font-family: arial, helvetica; font-size: 14px; width: 35px;">
                                                                <table width="300" cellpadding="0" cellspacing="0" border="0" align="center" class="width-260px">
                                                                    <tr>
                                                                        <td align="left" valign="middle" style="color: #001; font-family: arial, helvetica; font-size: 14px; width: 35px;">Time: </td>
                                                                        <td style="width: 50px"></td>
                                                                        <td align="left" valign="middle" style="color: #001; font-family: arial, helvetica; font-size: 14px; width: 215px;"><span class="datetime"><%= _App.AppointmentTime %></span></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                ...
                                <tr>
                                    <td align="left" style="font-size: 18px; color: #f8116a; font-family: arial, helvetica; line-height: 21px; text-align: left">Healthy employees are good for business. They don&#39;t just take less time off sick, they&#39;re <strong>three times more productive than employees in poor health&#185;</strong>.
                                    </td>
                                </tr>
                                <tr>
                                    <td height="23"></td>
                                ...
                                <tr>
                                    <td align="left" style="font-size: 14px; color: #000; font-family: arial, helvetica; line-height: 16px; text-align: left">VitalityHealth for Small Business is<b> award-winning health insurance</b> that helps you and your employees live a healthier lifestyle every day by
													rewarding you for being healthy - meaning you don't have to claim to be able to benefit. Like other insurance, it also protects employees when things go wrong.
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="left" style="font-size: 14px; color: #000; font-family: arial, helvetica; line-height: 16px; text-align: left">Our <strong>Full Cover Promise</strong> is included which means we take care of consultant fees in full so your employees don&#39;t have to pay any shortfall - as long as the consultant is recognised by us and the condition is eligible on the plan.</td>
                                </tr>
                                <tr>
                                    <td height="20" style="height: 20px;">
                                </tr>
                                <tr>
                                    <td align="left" style="font-size: 14px; color: #000; font-family: arial, helvetica; line-height: 16px; text-align: left">Through our range of health and reward partners, we offer your employees 
													<b>discounts, cashback and incentives to encourage them to be healthy</b> - saving them money at the same time.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 20px"></td>
                                ...
                                <tr>
                                    <td align="left" height="21" valign="top" style="font-size: 14px; color: #000; font-family: arial, helvetica; line-height: 16px; text-align: left">
                                        <b>Some of these benefits include:</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                        <table width="340" cellpadding="0" cellspacing="0" border="0" align="left" class="max-width">
                                            <tr>
                                                <td height="22" valign="top" style="width: 30px; text-align: center; color: #f8116a; line-height: 18px">&bull; </td>
                                                <td height="22" valign="top" align="left" style="font-family: arial, helvetica; font-size: 14px; line-height: 18px; text-align: left">Discounts on health screenings </td>
                                            </tr>

                                            <tr>
                                                <td height="40" style="width: 30px; text-align: center; color: #f8116a; line-height: 18px" valign="top">&bull; </td>
                                                <td height="40" valign="top" align="left" style="font-family: arial, helvetica; font-size: 14px; line-height: 18px; text-align: left">50% off Virgin Active monthly gym membership. A joining fee will apply&#178; </td>
                                            </tr>
                                            <tr>
                                                <td height="40" style="width: 30px; text-align: center; color: #f8116a; line-height: 18px" valign="top">&bull; </td>
                                                <td height="40" align="left" style="font-family: arial, helvetica; font-size: 14px; line-height: 18px; text-align: left">Up to 40&#37; off British Airways return economy flights within the UK and Europe&sup3;</td>
                                            </tr>
                                            <tr>
                                                <td height="40" style="width: 30px; text-align: center; color: #f8116a; line-height: 18px" valign="top">&bull; </td>
                                                <td height="40" align="left" style="font-family: arial, helvetica; font-size: 14px; line-height: 18px; text-align: left">A cinema ticket every week
												      for getting active and regularly tracking their exercise </td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="font-size: 14px; color: #000; font-family: arial, helvetica; line-height: 16px; text-align: left">If you currently have business health insurance please bring in a copy of your policy documents.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 20px"></td>
                                ...
                                <tr>
                                    <td align="left" style="font-size: 14px; color: #000; font-family: arial, helvetica; line-height: 16px; text-align: left">I'll be your Appointed Representative of VitalityHealth. Should you need to rearrange please call me on <span class="hidethis">
                                        <br>
                                    </span><b><strong>01204 843444</strong>.</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 20px"></td>
                                ...
                                <tr>
                                    <td align="left" style="font-size: 14px; color: #000; font-family: arial, helvetica; line-height: 16px; text-align: left">I look forward to meeting you soon.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 20px"></td>
            ...
            <td align="center" class="fullwidth" width="200">
                <table width="200" cellpadding="0" cellspacing="0" border="0" align="center" style="background-color: #f8116a;">
                    <tr>
                        <td>
                            <img src="<%=BaseURL%>/email/beach.png" width="199" height="185" class="imgfull" alt="beach" style="display: block; border: 0; font-family: arial, helvetica; font-size: 30px; line-height: 28px; color: #000000;" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <table width="160" cellpadding="0" cellspacing="0" border="0" align="center" style="background-color: #f8116a;" class="width-260px">
                                <tr>
                                    <td height="30px" style="height: 30px;"></td>
                                </tr>
                                <tr>
                                    <td align="left" style="color: #fff; font-family: arial, helvetica; font-size: 16px; line-height: 19px; text-align: left; font-style: italic;">
                                        <strong>&#34;Workplace wellbeing doesn't stop at the office door.</strong>
                                        It's important for us to show that we don't stop caring about our employees when they go home at night.
														Vitality represents the ethos of Eventura - rewarding team members for doing well,
														both in and out of the workplace. It also reinforces the idea of a healthy work/life balance.
														Everyone can clearly see that we care about their health and happiness. And that's brilliant for morale.&#34;
                                    </td>
                                </tr>
                                <tr>
                                    <td height="20" style="height: 20px;"></td>
                                ...
                                <tr>
                                    <td align="left" style="color: #fff; font-family: arial, helvetica; font-size: 16px; line-height: 20px; font-weight: bold; text-align: left">Chris Houghton,<br />
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="140" cellpadding="0" cellspacing="0" border="0" align="center" style="background-color: #e8e8e8;">
                                            ...
                                            <tr>
                                                <td height="24px" style="height: 24x;"></td>
                                            </tr>
                                            <tr>
