...
Public Class CQMembershipProvider
    ...
    Public Overrides ReadOnly Property PasswordStrengthRegularExpression() As String
        Get
            PasswordStrengthRegularExpression = Nothing
        End Get
    End Property
    ...
    Public Overrides Function ValidateUser(ByVal username As String, ByVal password As String) As Boolean
        ...
        Database.CreateParameter(Params, "@Username", Data.SqlDbType.NVarChar, username)
        Database.CreateParameter(Params, "@Password", Data.SqlDbType.NVarChar, password)
        Dim DS As DataSet = Database.ExecuteSP("spWebLogin", Params)
