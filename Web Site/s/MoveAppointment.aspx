        ...
        <% 
            ...
            For iApp As Integer = 1 To i
                ...
                For iDay As Integer = 0 To 4
                    ...
                    Dim sLink As String = "onclick=""javascript: location.href='MoveAppointmentDo.aspx?ID=" & AppointmentID & "&TargetDate=" & ThisDate.ToShortDateString & " " & CDate(UserRow.Item("AppTime" & iApp)).ToShortTimeString & "&P=" & iApp & "'"""
                    If CDate(ThisDate.ToLongDateString) < Today Then
                        sLink = " style=""background-color:lightgray"" "
                    End If
