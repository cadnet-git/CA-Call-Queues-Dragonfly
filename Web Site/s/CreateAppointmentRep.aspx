        ...
        <% 
            ...
            For iApp As Integer = 1 To i
                ...
                For iDay As Integer = 0 To 4
                    ...
                    Dim sLink As String = "onclick=""javascript: location.href='CreateAppointmentRepDo.aspx?Description=" & Request("Description") & "&TargetDate=" & ThisDate.ToShortDateString & " " & CDate(UserRow.Item("AppTime" & iApp)).ToShortTimeString & "&P=" & iApp & "'"""
