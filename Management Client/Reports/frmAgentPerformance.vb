Public Class frmAgentPerformance
    ...
    Private Sub frmAgentPerformanceStats_ClientSizeChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Me.ClientSizeChanged
        resizeme()
    End Sub
    ...
    Private Sub RefreshStats()
        ...
        DS = Database.ExecuteSP("GetAgentPerformanceStats", Params)
    ...
    Private Sub RefreshNumbers()
        ...
        For Each Rep In Reps
            ...
            LVitem.SubItems.Add(Format(Rep.DeadAdmin, "#,###,##0"))
            LVitem.SubItems.Add(Format(Rep.DeadCompany + Rep.DeadRep + Rep.DeadOther, "#,###,##0"))
    ...
    Private Sub RefreshPercent()
        ...
        For Each Rep In Reps
            ...
            LVitem.SubItems.Add(Format(Rep.PercentDeadAdmin, "#0.0"))
            aTotal.DeadAdmin = aTotal.DeadAdmin + Rep.DeadAdmin

            LVitem.SubItems.Add(Format(Rep.PercentDeadOthers, "#0.0"))
            aTotal.DeadOther = aTotal.DeadOther + Rep.DeadOther
            aTotal.DeadCompany = aTotal.DeadCompany + Rep.DeadCompany
            aTotal.DeadRep = aTotal.DeadRep + Rep.DeadRep
        ...
        lvTotal.SubItems(3).Text = Format(aTotal.PercentDeadAdmin, "#0.0")
        lvTotal.SubItems(4).Text = Format(aTotal.PercentDeadOthers, "#0.0")
